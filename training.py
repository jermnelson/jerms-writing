...
# Constants
from config import AIKI_NAMES, CLASS_NAMES, IMG_HEIGHT, IMG_WIDTH, TRAIN_DIR, VALID_DIR
...
def train(**kwargs):
    ...
    train_imgs, train_labels = zip(*(process_path(f_p) for f_p in train_paths))
    valid_imgs, valid_labels = zip(*(process_path(f_p) for f_p in valid_paths))
